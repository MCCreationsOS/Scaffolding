...
export function initializeContentRoutes() {
    app.post('/content', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        switch (req.body.content.type) {
            case "map":
                res.send(yield uploadMap(req.body, uploader === null || uploader === void 0 ? void 0 : uploader.user));
                break;
            default:
    ...
    app.post("/content/import", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (map) {
            ...
            let i = "";
            let isSlugUnique = yield checkIfSlugUnique(map.slu, "Maps");
            while (!isSlugUnique) {
                i += (Math.random() * 100).toFixed(0);
                isSlugUnique = yield checkIfSlugUnique(map.slug + i, "Maps");
            }
            map.slug = map.slug + i;
    ...
    app.post('/content/update', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!user.user || !currentMap || (((_a = currentMap.creators) === null || _a === void 0 ? void 0 : _a.filter(creator => { var _a; return creator.handle === ((_a = user.user) === null || _a === void 0 ? void 0 : _a.handle); }).length) === 0 && user.user.type !== UserTypes.Admin)) {
        ...
        let i = "";
        let isSlugUnique = (yield checkIfSlugUnique(map.slug, req.body.type)) || map.slug === currentMap.slug;
        console.log("Checking if slug is unique: " + isSlugUnique, map.slug, currentMap.slug);
        while (!isSlugUnique) {
            i += (Math.random() * 100).toFixed(0);
            isSlugUnique = yield checkIfSlugUnique(map.slug + i, req.body.type);
        }
        map.slug = map.slug + i;
...
function uploadContent(collection, body, uploader) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let i = "";
        let isSlugUnique = yield checkIfSlugUnique(slug, collection);
        while (!isSlugUnique) {
            i += (Math.random() * 100).toFixed(0);
            isSlugUnique = yield checkIfSlugUnique(slug + i, collection);
        }
        slug = slug + i;
        let map = {
        ...
        if (uploader) {
            ...
            return ({ key: key, slug: map.slug });
        }
    });
}
function uploadMap(body, uploader) {
    return __awaiter(this, void 0, void 0, function* () {
        uploadContent("Maps", body, uploader);
    });
}
...
export function checkIfSlugUnique(slug, collection) {
    return __awaiter(this, void 0, void 0, function* () {
        let database = new Database("content", collection);
