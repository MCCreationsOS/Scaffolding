...
export function initializeCommunityRoutes() {
    ...
    app.post('/maps/comment/:slug', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        let comment = yield comments.collection.insertOne({ username: req.body.username, comment: req.body.comment, date: Date.now(), likes: 0, handle: req.body.handle, approved: approved, slug: req.params.slug });
